...
class poseDetector:
    ...
    def findAngle(self, img, p1, p2, p3, draw=True): #Angle between the three points
        ...
        if draw:
            ...
            cv2.putText(img, str(int(angle)),(x2-50,y2+50),cv2.FONT_HERSHEY_PLAIN,3,(255,255,0),3)
